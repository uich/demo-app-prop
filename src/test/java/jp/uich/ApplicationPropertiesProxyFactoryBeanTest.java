...
public class ApplicationPropertiesProxyFactoryBeanTest {

  @Configuration
  static class ContextConfiguration {

    @Bean
    public ApplicationPropertiesProxyFactoryBean applicationProperties() {
      return new ApplicationPropertiesProxyFactoryBean();
    }
